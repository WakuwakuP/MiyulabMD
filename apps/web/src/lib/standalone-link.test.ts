...
test("standaloneLinkUrl accepts a lone URL or markdown link", () => {
  assert.equal(
    standaloneLinkUrl("https://example.com/a"),
    "https://example.com/a",
  );
  assert.equal(
    standaloneLinkUrl("[Example](https://example.com/a)"),
    "https://example.com/a",
  );
  assert.equal(standaloneLinkUrl("see https://example.com/a"), null);
  assert.equal(
    standaloneLinkUrl("text [Example](https://example.com/a)"),
    null,
  );
});
