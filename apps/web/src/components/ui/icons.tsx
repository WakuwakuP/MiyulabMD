...
export function EyeIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden className={cn("size-4", className)}>
...
export function FolderIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden className={cn("shrink-0 text-folder", className)}>
      <path
        fill="currentColor"
...
export function MarkdownIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden className={cn("shrink-0 text-note", className)}>
      <path
        fill="currentColor"
